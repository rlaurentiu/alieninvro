...
#'
#' A dataset containing occurrence records of alien invertebrate species
#' in Romania, including geographic coordinates, taxonomy, and metadata.
#'
...
#' }
#' @source Preda, C. et al. (submitted). From soil to stream and sea: species
#'   richness and distribution of alien invertebrates in Romania. Neobiota.
"species_data"

#' Pathway and origin data for alien invertebrate species
#'
#' A dataset containing information about introduction pathways and native
#' origins of alien invertebrate species in Romania.
#'
...
#'
#' A dataset indicating which data sources document each alien invertebrate
#' species in Romania.
#'
